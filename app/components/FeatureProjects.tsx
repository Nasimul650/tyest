...
//       description: 'A professional website for a law firm, showcasing their services and expertise.',
//       client: 'John Doe Law Firm'
//     },
//     {
//       image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80',
//       title: 'Web Developer',
//       description: 'Migrated their old CRM system to a scalable cloud-native architecture with added automation.',
//       client: 'NovaSoft Solutions'
//     }
//   ];

  return (
    <div className="relative bg-black py-20 px-6 overflow-hidden text-left">
      ...
      <div className="relative z-10">
          ...
          <div className="overflow-hidden relative">
            ...
            <div ref={topRowRef} className="flex gap-8 w-max">
              {[...projects, ...projects, ...projects].map((project, index) => (
                <ProjectCard key={`top-${index}`} {...project} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="relative mb-16 overflow-visible -rotate-3 transform">
          <div className="overflow-hidden relative">
            ...
            <div ref={bottomRowRef} className="flex gap-8 w-max -translate-x-[500px]">
              {[...projects, ...projects, ...projects].map((project, index) => (
                <ProjectCard key={`top-${index}`} {...project} />
              ))}
            </div>
